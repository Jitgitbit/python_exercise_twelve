...
print()
fig = plt.figure()
axesSet6 = fig.add_axes([0,0,1,1])
markedGraph = axesSet6.plot(x,y, marker= 'o', markersize= 10, markerfacecolor= 'red', markeredgecolor= 'g', markeredgewidth= 4)
print(markedGraph)
print('- - - - - - - - - - - - - - - - -')
print('Setting limits:')
print()
fig = plt.figure()
axesSet7 = fig.add_axes([0,0,1,1])
axesSet7.set_xlim([0,10])
axesSet7.set_ylim([0,60])
graphWithLimits = axesSet7.plot(x,y)
print(graphWithLimits)
print("----------------------------------")